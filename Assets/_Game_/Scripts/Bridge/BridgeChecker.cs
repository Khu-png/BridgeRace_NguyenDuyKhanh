...
public class BridgeChecker : MonoBehaviour
{
    ...
    private void BuildStep(Character character)
    {
        ...
        {
            if (character.characterMaterial != null)
            {
                RendererColorUtility.ApplyMaterial(mr, character.characterMaterial);
            }
            else
            {
                RendererColorUtility.ApplyColor(mr, character.characterColor);
            }
        }
